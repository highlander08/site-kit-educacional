...
type SectionId = 'hero' | 'intro' | 'offerings' | 'benefits' | 'contact' | 'kits' | 'materials' | 'demos';
...
const AboutPage: React.FC = () => {
  ...
  const sidebarItems: SidebarItem[] = [
    ...
    { id: 'offerings', label: 'Produtos', icon: <Lightbulb className="w-5 h-5" /> },
    { id: 'materials', label: 'Materiais', icon: <FileText className="w-5 h-5" /> },
    { id: 'demos', label: 'Demonstrações', icon: <Monitor className="w-5 h-5" /> },
  ...
  const offerings: Offering[] = [
    {
      ...
      description: "Manuais ilustrados e atividades experimentais alinhadas à BNCC"
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 relative overflow-x-hidden">
      {/* Sidebar */}
      <div className={`fixed left-0 top-0 h-full bg-slate-800/95 backdrop-blur-md shadow-2xl z-50 transition-transform duration-300 ${
      ...
      <div className="lg:ml-64 transition-all duration-300">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className={`transition-all duration-1000 delay-200 ${isVisible.intro ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                ...
                <p className="text-lg text-gray-300 leading-relaxed mb-8">
                  Somos uma empresa dedicada à criação de <strong className="text-blue-400">kits educacionais interativos 
        ...
        {/* What We Offer */}
        <section id="offerings" className="py-20 bg-gradient-to-br from-slate-800/30 to-indigo-900/20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-white mb-4">O que Oferecemos</h2>
                ...
                return (
                  <div 
                    ...
                    className={`transition-all duration-700 delay-${index * 150} ${
                      isVisible.materials ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                    }`}
                  >
              ...
              {videos.map((video, index) => (
                <div 
                  ...
                  className={`transition-all duration-700 delay-${index * 200} ${
                    isVisible.demos ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                  }`}
                >
        ...
        <section id="benefits" className="py-20 bg-slate-800/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-white mb-4">Benefícios para sua Instituição</h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
