...
import { Download, FileText, Video, Presentation, BookOpen, GraduationCap, Atom, Zap, Sun } from "lucide-react";
...
const temasData = {
  corpoNegro: {
    ...
    materiais: {
      pdf: {
        ...
        descricao: "Guia do professor para o tema Corpo Negro. Inclui experimentos de Planck e Wien.",
        url: "/downloads/guia-professor-corpo-negro.pdf",
        tamanho: "2.8 MB"
      },
      video: {
        titulo: "Vídeo: Radiação do Corpo Negro",
        descricao: "Vídeo explicativo sobre como ensinar o conteúdo de Corpo Negro",
      ...
      materialAluno: {
        ...
        descricao: "Apostila completa com teoria, exercícios e experimentos sobre radiação do corpo negro",
        url: "/downloads/material-aluno-corpo-negro.pdf",
        tamanho: "1.5 MB"
      }
    }
  },
  saltoQuantico: {
    ...
    materiais: {
      pdf: {
        ...
        descricao: "Guia do professor para o tema Salto Quântico. Explicações sobre níveis de energia.",
        url: "/downloads/guia-professor-salto-quantico.pdf",
        tamanho: "2.4 MB"
      },
      video: {
        titulo: "Vídeo: Salto Quântico",
        descricao: "Vídeo explicativo sobre como ensinar o conteúdo de Salto Quântico",
        url: "https://www.youtube.com/embed/dQw4w9WgXcQ",
      ...
      materialAluno: {
        ...
        descricao: "Apostila completa com teoria dos níveis de energia, exercícios e aplicações",
  ...
  efeitoFotoeletrico: {
    ...
    descricao: "Emissão de elétrons por metais quando iluminados e a explicação de Einstein",
    cor: "bg-green-500",
    ...
    materiais: {
      pdf: {
        ...
        descricao: "Guia do professor para o tema Efeito Fotoelétrico. Explicações sobre fótons e função trabalho.",
        url: "/downloads/guia-professor-efeito-fotoeletrico.pdf",
        tamanho: "2.6 MB"
      },
      video: {
        titulo: "Vídeo: Efeito Fotoelétrico",
        descricao: "Vídeo explicativo sobre como ensinar o Efeito Fotoelétrico e o Prêmio Nobel de Einstein",
        url: "https://www.youtube.com/embed/dQw4w9WgXcQ",
      ...
      materialAluno: {
        ...
        descricao: "Apostila completa com teoria quântica da luz, exercícios e experimentos",
        url: "/downloads/material-aluno-efeito-fotoeletrico.pdf",
        tamanho: "1.4 MB"
      }
    }
  }
...
const TeacherSupportPage = () => {
  ...
  const [secaoAtiva, setSecaoAtiva] = useState<"professor" | "aluno">("professor");
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-gray-800 mb-3">Resumo da Aula</h2>
              <p className="text-gray-600 text-lg leading-relaxed">
                Esta aula apresenta os conceitos fundamentais da Física Quântica. 
                Atualmente explorando: <span className={`font-semibold ${temaAtivo.corTexto}`}>{temaAtivo.nome}</span>.
                ...
                <motion.button
                  ...
                  className={`
                    ...
                    ${temaAtivo.id === tema.id 
                      ? 'ring-4 ring-offset-2 ring-opacity-50 ' + tema.cor.replace('bg-', 'ring-') 
        ...
        <AnimatePresence mode="wait">
          {isLoading ? (
            ...
            >
              {[...Array(secaoAtiva === "professor" ? 3 : 3)].map((_, index) => (
                <div key={index} className="bg-white rounded-2xl shadow-md p-8 animate-pulse">
            ...
            <motion.div 
              ...
              className={secaoAtiva === "professor" 
                ? "grid md:grid-cols-2 lg:grid-cols-3 gap-8"
                : "grid md:grid-cols-2 lg:grid-cols-3 gap-8"
              }
            >
              {secaoAtiva === "professor" ? (
                // Cards do Professor (específicos do tema selecionado)
                <>
                  ...
                  >
                    <div className="p-8">
                      <div className={`${temaAtivo.corLight} w-16 h-16 rounded-2xl flex items-center justify-center mb-6`}>
                  ...
                  {/* Card 3 – Slides do Professor */}
                  <motion.div
                    key={`slides-${temaAtivo.id}`}
                    variants={cardVariants}
                    whileHover="hover"
                    className="bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-xl transition-all"
                  >
                    <div className="p-8">
                      <div className={`${temaAtivo.corLight} w-16 h-16 rounded-2xl flex items-center justify-center mb-6`}>
                        <Presentation className={`w-8 h-8 ${temaAtivo.corTexto}`} />
                      </div>
                      
                      <h3 className="text-2xl font-semibold text-gray-800 mb-3">
                        Slides / Material Visual da Aula
                      </h3>
                      
                      <p className="text-gray-600 mb-6">
                        {temaAtivo.materiais.slides.descricao}
                      </p>
                      
                      <div className="space-y-3">
                        <a
                          href={temaAtivo.materiais.slides.urlPpt}
                          className={`flex items-center justify-between w-full ${temaAtivo.cor} ${temaAtivo.corHover} text-white font-medium py-3 px-6 rounded-xl transition-colors`}
                          download
                        >
                        ...
                        <a
                          href={temaAtivo.materiais.slides.urlPdf}
                          className={`flex items-center justify-between w-full ${temaAtivo.corLight} hover:${temaAtivo.corLight.replace('100', '200')} ${temaAtivo.corTexto} font-medium py-3 px-6 rounded-xl transition-colors`}
                          download
                        >
                      ...
                      >
                        <div className="p-8">
                          <div className="flex items-center gap-4 mb-6">
                            <div className={`${tema.corLight} w-16 h-16 rounded-2xl flex items-center justify-center`}>
                              <Icon className={`w-8 h-8 ${tema.corTexto}`} />
                            </div>
                            <div>
                              <span className={`text-sm font-medium ${tema.corTexto}`}>
                                Material do Aluno
                              </span>
                          ...
                          <div className="space-y-3 mb-6">
                            <div className="flex items-center gap-2 text-sm text-gray-500">
                              <BookOpen size={16} />
                              <span>24 páginas • 15 exercícios • 3 experimentos</span>
                            </div>
                          </div>
                          ...
                          >
                            <Download size={20} />
                            Baixar Material ({tema.materiais.materialAluno.tamanho})
                          </a>
                        </div>
                      </motion.div>
                    );
